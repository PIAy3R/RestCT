...
class BasicLanguageModel:
    ...
    def call(self) -> [str, List[Dict[str, str]]]:
...
class ResponseModel(BasicLanguageModel):
    def __init__(self, operation: RestOp, manager, config: Config, temperature: float = 0.9,
